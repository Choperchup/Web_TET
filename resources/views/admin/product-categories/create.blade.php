    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <h1 class="mb-4 text-dark">Tạo Danh mục Sản phẩm Mới</h1>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.product-categories.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                {{-- Danh mục Cha (Chỉ hiển thị danh mục gốc) --}}
                                <div class="col-12 mb-3">
                                    <label for="parent_id" class="form-label">Danh mục Cha</label>
                                    <select name="parent_id" id="parent_id"
                                        class="form-select @error('parent_id') is-invalid @enderror">
                                        <option value="">-- Chọn Danh mục Cấp 1 (Nếu là danh mục con) --</option>
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <input type="text" name="icon_url" id="icon_url" value="{{ old('icon_url') }}"
