    ...
    <div class="card p-4">
        ...
        <form action="{{ route('admin.posts.update', $posts->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input name="title" value="{{ old('title', $posts->title) }}" class="form-control" required>
            </div>
            <div class="mb-3 row">
                <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <input name="meta_title" class="form-control" value="{{ old('meta_title', $posts->meta_title) }}">
            </div>
            <div class="mb-3">
                <label class="form-label">Meta description</label>
                <textarea name="meta_description" class="form-control"
                    rows="2">{{ old('meta_description', $posts->meta_description) }}</textarea>
            </div>
